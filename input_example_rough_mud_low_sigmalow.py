...
p = fdfault.problem('rough_fault_muD_sigmalow')
...
x = 12.*np.ones(1601)+generate_profile(1601, 32, 10**-2,20, h = 1., seed=None, sd = 1.e-1)
...
p.add_pert(fdfault.swparam('constant', dc = 0.4, mus = 0.676, mud = 0.2),0)
...
p.add_output(fdfault.output('vxbody','vx',0, 300, 50, 0, 1200, 2, 0, 1600, 2, 0, 0, 1))
p.add_output(fdfault.output('vybody','vy',0, 300, 50, 0, 1200, 2, 0, 1600, 2, 0, 0, 1))
p.add_output(fdfault.output('vfault','V',0, 300, 50, 601, 601, 1, 0, 1600, 2, 0, 0, 1))
