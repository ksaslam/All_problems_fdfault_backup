...
p.set_nblocks((1,4,1))
p.set_nx_block(([nx], [ny2, ny1, ny1, ny2], [nz]))

# set block dimensions

p.set_block_lx((0,0,0),(50., 19.2, 20.))
p.set_block_lx((0,1,0),(50., 0.8, 20.))
p.set_block_lx((0,2,0),(50., 0.8, 20.))
p.set_block_lx((0,3,0),(50., 19.2, 20.))
...
p.set_bounds((0,1,0),['absorbing', 'absorbing', 'none', 'none', 'absorbing', 'free'])
p.set_bounds((0,2,0),['absorbing', 'absorbing', 'none', 'none', 'absorbing', 'free'])
p.set_bounds((0,3,0),['absorbing', 'absorbing', 'none', 'absorbing', 'absorbing', 'free'])
...
p.set_material(fdfault.material('elastic', rho, rho*(cp**2-2.*cs**2), rho*cs**2), (0,2,0))

cs = 3.464
cp = 6.

p.set_material(fdfault.material('elastic', rho, rho*(cp**2-2.*cs**2), rho*cs**2), (0,3,0))
...
p.add_pert(fdfault.swparam('constant',0., 0., 0., 0., 0., 0.18, 0.55, 0.45),1)
...
for station in onfault:
    ...
    xpt, ypt, zpt = p.find_nearest_point((xcoord, 0., zcoord), known='y', knownloc=ny1+ny2)
